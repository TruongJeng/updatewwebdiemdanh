...
<head>
    ...
    <title>403 – Không có quyền truy cập | CLB Kỹ năng Đoàn</title>
...
<body class="font-sans min-h-screen flex items-center justify-center p-5 relative overflow-hidden bg-gradient-to-br from-slate-50 via-primary-50 to-primary-100 text-slate-800 selection:bg-primary-200 selection:text-primary-900">
    ...
    <main class="w-full max-w-sm relative z-10 text-center">
        <div class="bg-white/85 backdrop-blur-xl rounded-2xl p-8 shadow-[0_20px_50px_-15px_rgba(28,150,101,0.18)] border border-white/80">
            ...
            <!-- Error Number -->
            <div class="text-8xl font-black text-red-100 leading-none mb-2 select-none animate-pulse-slow">403</div>

            <!-- Icon -->
            <div class="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-red-50 text-red-500 mb-5 shadow-inner border border-red-100">
                <i class="bi bi-shield-lock-fill text-3xl"></i>
            </div>

            <h1 class="text-xl font-extrabold text-slate-800 tracking-tight mb-2">Từ chối truy cập</h1>
